...
enum ble_msg_idx
{
    ...
    ble_evt_flash_ps_key_idx =179,
    ble_evt_attributes_value_idx =180,
    ble_evt_attributes_user_read_request_idx =181,
    ble_evt_attributes_status_idx =182,
    ble_evt_connection_status_idx =183,
    ble_evt_connection_version_ind_idx =184,
    ble_evt_connection_feature_ind_idx =185,
    ble_evt_connection_raw_rx_idx =186,
    ble_evt_connection_disconnected_idx =187,
    ble_evt_attclient_indicated_idx =188,
    ble_evt_attclient_procedure_completed_idx =189,
    ble_evt_attclient_group_found_idx =190,
    ble_evt_attclient_attribute_found_idx =191,
    ble_evt_attclient_find_information_found_idx =192,
    ble_evt_attclient_attribute_value_idx =193,
    ble_evt_attclient_read_multiple_response_idx =194,
    ble_evt_sm_smp_data_idx =195,
    ble_evt_sm_bonding_fail_idx =196,
    ble_evt_sm_passkey_display_idx =197,
    ble_evt_sm_passkey_request_idx =198,
    ble_evt_sm_bond_status_idx =199,
    ble_evt_gap_scan_response_idx =200,
    ble_evt_gap_mode_changed_idx =201,
    ble_evt_hardware_io_port_status_idx =202,
    ble_evt_hardware_soft_timer_idx =203,
    ble_evt_hardware_adc_result_idx =204,
};
