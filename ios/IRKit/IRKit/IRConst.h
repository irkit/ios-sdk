...
#define IRKIT_CHARACTERISTICS @[ IRKIT_CHARACTERISTIC_IR_DATA_UUID, IRKIT_CHARACTERISTIC_CONTROL_POINT_UUID, IRKIT_CHARACTERISTIC_CARRIER_FREQUENCY_UUID, IRKIT_CHARACTERISTIC_AUTHORIZATION_UUID ]
