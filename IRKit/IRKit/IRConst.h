...
#define IRKIT_SERVICE_UUID_STRING (@"6C29D110-BE00-419A-BDDC-D4FA6228A20F")
#define IRKIT_SERVICE_UUID        [CBUUID UUIDWithString: IRKIT_SERVICE_UUID_STRING]

#define IRKIT_CHARACTERISTIC_IR_DATA_UUID_STRING (@"06853C75-1617-4D10-822F-40C2018B6B53")
